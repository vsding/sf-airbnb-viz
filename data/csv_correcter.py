...
if __name__ == "__main__":
    ...
    #     ['host_response_rate', 'review_scores_rating', 'id'])
    # data_q2_1.to_csv('q2_1.csv', index=False)

        # Q2_2:
    # data_q2_2 = import_data(['minimum_nights', 'review_scores_rating', 'id'])
    # data_q2_2.to_csv('q2_2.csv', index=False)
